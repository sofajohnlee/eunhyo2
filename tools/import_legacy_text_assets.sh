...
#
# Copies the original Hari AIML/config text assets from a local checkout of
# sofajohnlee/eunhyo into this modernized project without rewriting content.
...
echo "Verify with: git diff -- app/src/main/assets/Hari"
